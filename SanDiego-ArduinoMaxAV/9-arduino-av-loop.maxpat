...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 133.0, 837.5, 185.0, 42.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 154.0, 502.0, 65.0, 42.0 ],
					"text" : "Volume"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 118.0, 822.5, 185.0, 42.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 73.0, 502.0, 65.0, 42.0 ],
					"text" : "Turn ON"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 178.0, 882.5, 185.0, 74.0 ],
					"presentation" : 1,
					"presentation_linecount" : 4,
					"presentation_rect" : [ 660.0, 447.0, 44.0, 90.0 ],
					"text" : "set\nhigh\nlight level"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 163.0, 867.5, 185.0, 74.0 ],
					"presentation" : 1,
					"presentation_linecount" : 4,
					"presentation_rect" : [ 588.0, 451.0, 46.0, 90.0 ],
					"text" : "set\nlow\nlevel level"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 148.0, 852.5, 185.0, 42.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 509.0, 451.0, 44.0, 58.0 ],
					"text" : "light level"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 439.0, 454.0, 59.0, 58.0 ],
					"text" : "light flanger"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 118.0, 822.5, 185.0, 42.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 352.0, 394.0, 85.0, 42.0 ],
					"text" : "Loop End"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 103.0, 807.5, 185.0, 42.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 229.0, 398.0, 85.0, 42.0 ],
					"text" : "Loop Start "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 88.0, 792.5, 185.0, 43.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 10.0, 334.0, 98.0, 43.0 ],
					"text" : "Toggle \nController"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 88.0, 792.5, 185.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 31.0, 211.0, 67.0, 27.0 ],
					"text" : "Play"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 351.0, 10.0, 81.0, 42.0 ],
					"text" : "pitch shift"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 73.0, 777.5, 185.0, 42.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 232.0, 10.0, 86.0, 42.0 ],
					"text" : "speed shift"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 58.0, 762.5, 185.0, 42.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 97.0, 10.0, 108.0, 42.0 ],
					"text" : "normal speed"
				}
...
, 			{
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "C:\\Users\\Esther\\Downloads\\ATLS 3200\\Song Composition Draft12.mp3",
								"filename" : "Song Composition Draft12.mp3",
								"filekind" : "audiofile",
								"id" : "u478007964",
								"selection" : [ 0.470185728250244, 0.940371456500489 ],
								"loop" : 0,
								"content_state" : 								{
									"pitchshift" : 0.04,
									"speed" : 0.55
...
,
		"dependency_cache" : [ 			{
				"name" : "Song Composition Draft12.mp3",
				"bootpath" : "~/Downloads/ATLS 3200",
				"patcherrelativepath" : "../../ATLS 3200",
				"type" : "Mp3",
				"implicit" : 1
			}
, 			{
